...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('project_project', 'status', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Project.status'
        db.alter_column('project_project', 'status', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'project.project': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'misc'", 'max_length': '30'}),
