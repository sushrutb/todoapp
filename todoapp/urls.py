...
urlpatterns = patterns('',
                       ...
                       url(r'^introduction/$', 'todo.views.view_introduction'),
                       url(r'^tag/(?P<tag_name>[-\w]+)/$', 'todo.views.get_tag_view'),
                       url(r'wiki_view/(?P<tag_name>[-\w]+)/$', 'wiki.views.show_wiki_view'),
                       url(r'demo/(?P<tag_name>[-\w]+)/$', 'wiki.views.show_demo_wiki_view'),
